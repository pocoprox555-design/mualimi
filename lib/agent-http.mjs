...
function buildSystemPrompt(memory = '', branch = '') {
  return [
    ...
    'عند الاختبار: اقرأ الصفحات المطلوبة أولًا ثم أنشئ أسئلة تعليمية مفصلة من محتواها الفعلي. كل سؤال يجب أن يكون واضحًا ومفسّرًا وكأن الطالبة لا تعرف المنهج — مثلاً بدل "ما قيمة 5!؟" اكتب "في المضروبات، المضروب n! يعني ضرب جميع الأعداد من 1 إلى n. ما هي قيمة 5! ؟". أضف شرحًا مفصلاً للإجابة الصحيحة يوضح السبب والطريقة. استخدم present_quiz بأسئلة متنوعة وخيارات وإجابة صحيحة وشرحاً تعليميًا مفصلاً للتصحيح الفوري.',
    '',
